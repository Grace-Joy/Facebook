...
<div class="container row">
    ...
    <div class="container col-4">
        <h1 style="font-size: 25px;font-family: Baskerville, Palatino Linotype, Palatino, Century Schoolbook L, Times New Roman, serif;">
            Sign Up Today To Join Our Beautiful Community</h1>
        <form action="registration.php" method="post">
            <!--				<input type="text" class="form-control" name="surname" placeholder="Input your Surname">-->
            <!--				<br>-->
            <input type="text" class="form-control" name="username" placeholder="Input your username" required>
            <br>
            <input type="text" class="form-control" name="names" placeholder="Input your names" required>
            <br>
            <input type="text" class="form-control" name="email" placeholder="Input your email" required>
            <br>
            <input type="password" class="form-control" name="password" placeholder="Input your password" required>
            <br>
            <input type="password" class="form-control" name="confirm_password" placeholder="Password confirmation" required>
            <br>
